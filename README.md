...
In-Depth Version
----------------
The language bar is shown for all pages in the main namespace. Links are automatically generated by simply appending `/fr` to the end of English page titles and vice versa. With the way the old `{{Languages}}` template was being used, most of the French pages already have a redirect for `/fr` pages.
